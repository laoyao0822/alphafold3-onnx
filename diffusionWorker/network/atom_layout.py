...
def convertV2(
    gather_idxs,gather_mask,gather_input_shape,
    arr: torch.Tensor,
    *,
...
#     layout_shape = arr.shape[layout_axes_begin:layout_axes_end]
#
#     gather_input_shape=gather_input_shape.cpu()
#     # we force the input_shape to be on the CPU
#     assert gather_input_shape.device == torch.device("cpu")
#     gather_info_input_shape = gather_input_shape.numpy()
#     # print("layout shape", layout_shape)
#     # print("gather_input_shape", gather_info_input_shape)
#     # print("layout shape", layout_shape[0],layout_shape[1:])
#     # print("gather_input_shape", gather_info_input_shape[0],gather_info_input_shape[1:])
#     # # print(isinstance(gather_info_input_shape, torch.Tensor))
...
#             f'the gather info expects shape {gather_input_shape}. '
...
def convert(
    ...
    *,
    ...
    return convertV2(gather_info.gather_idxs,gather_info.gather_mask,gather_info.input_shape,
                     arr,layout_axes=layout_axes)
# ref:
# @dataclasses.dataclass(frozen=True)
# class AtomLayout:
