...
from diffusionWorker.network import atom_layout
from diffusionWorker.network.layer_norm import LayerNorm
from diffusionWorker.network.gated_linear_unit import gated_linear_unit
from diffusionWorker.network.dot_product_attention import dot_product_attention_torch
...
class DiffusionTransition(nn.Module):
    ...
    def forward(self, x: torch.Tensor, single_cond: Optional[torch.Tensor] = None) -> torch.Tensor:
        ...
        c = gated_linear_unit(x, self.transition1.weight.T)
