...
from evoWorker.network.attention import GridSelfAttention
...
class PairformerBlock(nn.Module):
    ...
    def forward(self,num_res,attn_mask) :
        self.pair_attention1(num_res,attn_mask)
        self.pair_attention2(num_res,attn_mask)
